...
public class Main {
    ...
    private static void eliminarEmpleado() {
        ...
        for (int i = 0; i < listaDeEmpleados.size(); i++) {
            ...
            if (listaDeEmpleados.get(i).getCarnet().equals(carnet)){
                ...
                System.out.println("\nModelos.Empleado eliminado exitosamente...\n");
    ...
    private static void agregarEmpleado() {
        ...
        System.out.println("\nModelos.Empleado agregado exitosamente...\n");
        ...
        while (true) {
            try{
                System.out.println("Seleccione una opcion:\n"
                        + "\t1. Modelos.Empleado a tiempo completo\n"
                        + "\t2. Modelos.Empleado a tiempo parcial\n"
                        + "\t3. Modelos.Empleado a temporal"
                );
    ...
    private static void imprimirMenu() {
        System.out.println("Seleccione una opcion:\n"
                + "\t1. Agregar Modelos.Empleado\n"
                + "\t2. Modificar Salario Base de un Modelos.Empleado\n"
                + "\t3. Eliminar Modelos.Empleado\n"
                + "\t4. Mostrar datos de un Modelos.Empleado\n"
